#-------------------------------------------------
#
# Project created by QtCreator 2014-09-15T19:40:56
#
#-------------------------------------------------


#boost版本 -------------> boost_1_56_0-msvc-11.0-64
#Qt版本  --------------> qt-windows-opensource-5.2.0-msvc2012-x86_64-offline
...
#背景减除头文件
#INCLUDEPATH += P:/user/yuliyang/qt/untitled/package_bgs \
#INCLUDEPATH += P:/user/yuliyang/qt/untitled/package_tracking \
#INCLUDEPATH += P:/user/yuliyang/qt/untitled/package_analysis \
